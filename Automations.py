...
from DataBase.OnlineClasses.Links import Physics
...
def WhatsappMsg(name,message):
    ...
    startfile("C:\\Users\\Md Shakib Hossain\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
...
def YouTubeAuto(command):
    ...
    if 'pause' in query:
        ...
        web.open("https://www.youtube.com/channel/UCVeFelmejClbuEPaWq2Eriw")
...
def Notepad():
    ...
    path_1 = "C:\\Users\\Md Shakib Hossain\\OneDrive - virtualtea\\Documents\\MonaLisa\\" + str(filename)

    path_2 = "C:\\Users\\Md Shakib Hossain\\OneDrive - virtualtea\\Documents\\MonaLisa\\DataBase\\NotePad\\" + str(filename)
